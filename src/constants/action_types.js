...
export const ADD_NODE_PREDICATE = 'ADD_NODE_PREDICATE';
export const REMOVE_NODE_PREDICATE = 'REMOVE_NODE_PREDICATE';
export const RENAME_NODE_PREDICATE = 'RENAME_NODE_PREDICATE';
