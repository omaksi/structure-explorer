...
export class ConstantNodeFactory extends AbstractReactFactory<ConstantNodeModel, DiagramEngine> {
	...
	generateReactWidget(event:any): JSX.Element {
		...
		return <ConstantNodeWidget checkBadName={reduxProps["checkBadName"]} removeConstantNode={reduxProps["removeConstantNode"]} renameDomainNode={reduxProps["renameDomainNode"]} engine={this.engine} size={50} node={event.model}/>;
	}
