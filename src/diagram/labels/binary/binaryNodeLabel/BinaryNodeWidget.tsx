...
export class BinaryNodeWidget extends React.Component<BinaryNodeWidgetProps,UnBinaryNodeWidgetState> {
	constructor(props:BinaryNodeWidgetProps){
		super(props);
