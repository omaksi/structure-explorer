...
export const FIRST_QUESTION = (params) => <>Aký je tvoj predpoklad o formule <b>{params}</b>?</>;
export const ENTRY_SENTENCE = (formula, truth) => <>Predpokladáš, že formula <b>{formula}</b> je <b>{truth}</b>.</>;
