...
function FunctionInterpretation({functions,structure,setFunctionValueText,lockFunctionValue,teacherMode,toggleTable,domain,structureObject,setFunctionValueTable,lengthOfCol}){
    return(
        <Col lg={lengthOfCol}>
            <fieldset>
